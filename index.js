                ...
                if (change.field === 'comments' && change.value.from.username !== 'chamoyavispa') {
                    ...
                    try {
                        const gptResponse = await openai.chat.completions.create({
                            model: 'ft:gpt-3.5-turbo-1106:personal:chamoy-exp-1:AxnREQ9P',
                            messages: [
                                {
                                    role: 'system',
